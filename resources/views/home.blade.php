    ...
    <div class="wrap">
        <div class="service-grids">
            <div class="images_1_of_4">
                <img src="{{asset('img/round1.png')}}">
                <h3>Custom Design</h3>
                <p>Lorem ipsum is simply dummy text of the printing and typesetting industry.Lorem ipsum has been </p>
                <div class="button"><span><a href="#">Read More</a></span></div>
            </div>
            <div class="images_1_of_4">
                <img src="{{asset('img/round2.png')}}">
                <h3>Web Design</h3>
                <p>Lorem ipsum is simply dummy text of the printing and typesetting industry.Lorem ipsum has been</p>
                <div class="button"><span><a href="#">Read More</a></span></div>
            </div>
            <div class="images_1_of_4">
                <img src="{{asset('img/round3.png')}}">
                <h3>Blog pages</h3>
                <p>Lorem ipsum is simply dummy text of the printing and typesetting industry.Lorem ipsum has been </p>
                <div class="button"><span><a href="#">Read More</a></span></div>
            </div>
            <div class="images_1_of_4">
                <img src="{{asset('img/round4.png')}}">
        ...
        <div class="wrap">
            ...
            <div id="small-dialog1" class="mfp-hide">
                <div class="pop_up">
                    ...
                    <p class="pop_p">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
                        Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.
                        Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie.</p>
                </div>
            </div>
                    ...
                    <div id="gallerylist">
                        <div class="gallerylist-wrapper">
                            <a class="popup-with-zoom-anim" href="#small-dialog1">
                                <img src="{{ asset('img/gd1.jpg') }}" alt="Image 1"/>
                            </a>
                        </div>
                        <div class="gallerylist-wrapper">
                            <a class="popup-with-zoom-anim" href="#small-dialog2">
                                <img src="{{ asset('img/gd2.jpg') }}"  alt="Image 1"/>
                            </a>
                        </div>
                        <div class="gallerylist-wrapper">
                            <a class="popup-with-zoom-anim" href="#small-dialog3">
                                <img src="{{ asset('img/gd3.jpg') }}"  alt="Image 1"/>
                    ...
                    <div id="gallerylist1">
                        <div class="gallerylist-wrapper">
                            <a class="popup-with-zoom-anim" href="#small-dialog4">
                                <img src="{{ asset('img/gd4.jpg') }}" alt="Image 1" />
                            </a>
                        </div>
                        <div class="gallerylist-wrapper">
                            <a class="popup-with-zoom-anim" href="#small-dialog5">
                                <img src="{{ asset('img/gd5.jpg') }}"  alt="Image 1"/>

                            </a>
                        </div>
                        <div class="gallerylist-wrapper">
                            <a class="popup-with-zoom-anim" href="#small-dialog6">
                                <img src="{{ asset('img/gd6.jpg') }}"  alt="Image 1"/>
                            </a>
                        </div>
                        <div class="clear"> </div>
    ...
    <div class="wrap">
        ...
        <div class="middle-grids">
            <div class="grid_1_of_4 images_1_of_4">
                ...
                <img src="{{ asset('img/pic4.jpg') }}"  alt="Image 1"/>
                <h3>Adrian Thomas </h3>
                <h4>CEO&Founder</h4>
                <p>Lorem ipsum is simply dummy text of the printing and typesetting industry.Lorem ipsum has been </p>
            </div>
        ...
        <div class="contact-form">
            <div class="para-contact">
                ...
                <div class="get-intouch-left-address">
                    <p>Hanrapetutyan hraparak</p>
                    <p>Erevan. Armenia.</p>
                    <p>(777) 1234 567</p>
                    <p><a href="mailto:info@shmavon.com"> shmavon.com</a></p>
                </div>
                <div class="clear"> </div>
            </div>
            <div class="form">
